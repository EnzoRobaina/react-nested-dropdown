...
var Option = function (_a) {
    ...
    var _f = useState(''), menuPositionClassName = _f[0], setMenuPositionClassName = _f[1];
    var _g = useState(false), submenuIsOpen = _g[0], setSubmenuOpen = _g[1];
    var _h = useState(''), searchValue = _h[0], setSearchValue = _h[1];
    var _j = useState(false), setRenderTrigger = _j[1];
    ...
    var removeHoverClassTimeoutRef = useRef(null);
